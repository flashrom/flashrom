 ...
 */
	...
	{
		.vendor		= "Winbond",
		/* W25Q80RV has the same id as W25Q80BV/W25Q80DV but differs in Status Register-2/3 commands */
		.name		= "W25Q80RV",
		.bustype	= BUS_SPI,
		.manufacture_id	= WINBOND_NEX_ID,
		.model_id	= WINBOND_NEX_W25Q80_V,
...

	{
		...
		.bustype	= BUS_SPI,
		.manufacture_id = WINBOND_NEX_ID,
		.model_id	= WINBOND_NEX_W77Q32JW,
		.total_size	= 2048,
		.page_size	= 256,
		/* OTP: 1024B total, 256B reserved; read 0x48; write 0x42, erase 0x44, read ID 0x4B */
		.feature_bits	= FEATURE_WRSR_WREN | FEATURE_WRSR2 | FEATURE_WRSR3 | FEATURE_WRSR_EXT2 | FEATURE_OTP | FEATURE_QPI,
		.tested 	= TEST_OK_PREW,
		.probe		= PROBE_SPI_RDID,
		.probe_timing	= TIMING_ZERO,
		.block_erasers	=
...

	{
		...
		.bustype	= BUS_SPI,
		.manufacture_id	= WINBOND_NEX_ID,
		.model_id	= WINBOND_NEX_W77Q64JV,
		.total_size	= 8192,
		.page_size	= 256,
		/* OTP: 1024B total, 256B reserved; read 0x48; write 0x42, erase 0x44, read ID 0x4B */
		.feature_bits	= FEATURE_WRSR_WREN | FEATURE_WRSR2 | FEATURE_WRSR3 | FEATURE_WRSR_EXT2 |
				  FEATURE_OTP | FEATURE_QPI | FEATURE_4BA,
		.tested 	= TEST_OK_PREW,
		.probe		= PROBE_SPI_RDID,
		.probe_timing	= TIMING_ZERO,
		.block_erasers	=
...

	{
		...
		.bustype	= BUS_SPI,
		.manufacture_id = WINBOND_NEX_ID,
		.model_id	= WINBOND_NEX_W77Q128JV,
		.total_size	= 16384,
		.page_size	= 256,
		/* OTP: 1024B total, 256B reserved; read 0x48; write 0x42, erase 0x44, read ID 0x4B */
		.feature_bits	= FEATURE_WRSR_WREN | FEATURE_WRSR2 | FEATURE_WRSR3 | FEATURE_WRSR_EXT2 |
