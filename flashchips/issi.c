 ...
 */
...

	{
		...
		.bustype	= BUS_SPI,
		.manufacture_id	= ISSI_ID_SPI,
		.model_id	= ISSI_IS25LP512MG,
		.total_size	= 65536,
		.page_size	= 256,
		/* supports SFDP */
		/* OTP: 4x512B total; read 0x68; write 0x62, erase 0x64 */
		/* Not FEATURE_4BA_ENTER: EX4B is 29h, not E9h (E9h is UNPWD). */
